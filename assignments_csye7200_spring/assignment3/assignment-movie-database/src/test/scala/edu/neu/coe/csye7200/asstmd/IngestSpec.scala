...
class IngestSpec extends FlatSpec with Matchers {
  ...
  it should "work for Int" in {
    ...
    xys.size should be (1) // fastest to compile
    xys.head shouldBe Success(42) // TO BE IMPLEMENTED check that xys has exactly one element, consisting of Success(42) -- 10 points //TODO: implement this line
  }
